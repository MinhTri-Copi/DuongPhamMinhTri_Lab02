...
<?php endif; ?>
<form method="POST" action="/ma_nguon_mo_project_lab2/Product/update" enctype="multipart/form-data"
...
<a href="/ma_nguon_mo_project_lab2/Product/list" class="btn btn-secondary mt-2">Quay lại danh sách 
sản phẩm</a>
